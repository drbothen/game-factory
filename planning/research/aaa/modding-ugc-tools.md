...
inputs:
  - planning/research/aaa/engineering-disciplines.md        # data-oriented/ECS, architecture-separation rule, headless-contract tiers, BC/VP
  - planning/research/aaa/game-design-discipline.md          # data-driven content, Tier-A/B/C artifact taxonomy, schema-validated content
  - planning/research/aaa/security-anticheat-trust-safety.md # UGC moderation/T&S, CSAM/OSA/DSA/COPPA legal duties, moderation-pipeline-contract, server-authority
  - planning/research/aaa/online-services-platform-distribution.md # distribution-adapter, human-gated tier, wrap-first BaaS, mod.io adjacency
  - planning/research/aaa/production-pipeline.md             # DAM, large-binary VCS, derived-data cache
  - planning/research/aaa/AAA-RECONCILIATION.md              # BC/VP mapping, convergence model, scope, risk register, R-009 confabulation meta-lesson
sources:
...
`planning/research/aaa/engineering-disciplines.md` (data-oriented/ECS, architecture-separation rule,
headless-contract tiers, BC/VP), `planning/research/aaa/game-design-discipline.md` (data-driven
content, Tier-A/B/C taxonomy, schema-validated content), `planning/research/aaa/security-anticheat-
trust-safety.md` (`moderation-pipeline-contract`, CSAM/OSA/DSA/COPPA, server-authority),
`planning/research/aaa/online-services-platform-distribution.md` (distribution-adapter, `human-gated`
tier, wrap-first BaaS), `planning/research/aaa/production-pipeline.md` (DAM/large-binary),
`planning/research/aaa/AAA-RECONCILIATION.md` (BC/VP mapping, convergence model, scope, R-009).
