...
> protocol (`planning/design/engine-adapter-protocol.md`) so the factory stays platform-agnostic
...
`planning/research/aaa/{engineering-disciplines,production-pipeline,qa-testing-liveops}.md`,
`planning/research/aaa/AAA-RECONCILIATION.md`, `planning/design/engine-adapter-protocol.md`,
`.factory/specs/product-brief.md`.
