...
inputs:
  - planning/research/aaa/engineering-disciplines.md   # server-authoritative tier, networking testability, determinism tiers
  - planning/research/aaa/qa-testing-liveops.md         # replay-regression, telemetry, cert, machine-vs-human boundary
  - planning/research/aaa/AAA-RECONCILIATION.md         # BC/VP mapping, convergence model, scope, risk register
...
`planning/research/aaa/engineering-disciplines.md` (§2.6 server-authoritative tier, §8.3
networking-convergence contract), `planning/research/aaa/qa-testing-liveops.md` (§4
replay-regression, telemetry, machine-vs-human boundary),
`planning/research/aaa/AAA-RECONCILIATION.md` (BC/VP mapping §4, convergence model §7, scope §10,
