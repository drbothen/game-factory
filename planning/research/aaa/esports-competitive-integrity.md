...
inputs:
  - planning/research/aaa/engineering-disciplines.md          # netcode tiers, deterministic lockstep/rollback, determinism spine
  - planning/research/aaa/security-anticheat-trust-safety.md  # competitive integrity, anti-cheat wrap-not-build, server-authority invariants
  - planning/research/aaa/qa-testing-liveops.md               # deterministic replay-regression (PRIMARY synergy), telemetry, machine-vs-human boundary
  - planning/research/aaa/online-services-platform-distribution.md  # matchmaking/leaderboards backend (Nakama/EOS/PlayFab/GameLift FlexMatch)
  - planning/research/aaa/game-design-discipline.md           # competitive balance, frame data, design-intent-as-contract
  - planning/research/aaa/AAA-RECONCILIATION.md               # BC/VP mapping, 9-dim convergence, scope, genre strategy, risk register, R-009 confabulation lesson
  - planning/decisions/0003-determinism-tier-capability.md    # (referenced via prior docs)
sources:
...
`planning/research/aaa/engineering-disciplines.md` (§2.6 netcode tiers, §5 lockstep/rollback = replay-with-peers),
`planning/research/aaa/security-anticheat-trust-safety.md` (§2 anti-cheat wrap-not-build, §6 server-authority +
interest-management invariants, §9 lockstep = strongest anti-cheat),
`planning/research/aaa/qa-testing-liveops.md` (§4 deterministic replay-regression — PRIMARY synergy, determinism tiers,
desync checksums), `planning/research/aaa/online-services-platform-distribution.md` (matchmaking/leaderboard backends),
`planning/research/aaa/game-design-discipline.md` (competitive balance / frame data),
`planning/research/aaa/AAA-RECONCILIATION.md` (BC/VP §4, convergence §7, genre strategy §11, R-009 / R-010 §12).
