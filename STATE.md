...
**Current clean-pass counter: 0/3** (restart #3 still seeking clean #1). Next action: Pass 60 (candidate clean #1). Pass 59 FINDINGS (F59-01 fixed: BC-5.04.002 v1.3 reciprocal OBS-20-B subordination + Invariant-2/Arch-Module reframed as validation view; F59-02 = re-observation of FU-013, no new FU).
...
| phase-1d-adversarial | Adversarial spec convergence (>=3 clean passes); Passes 1–59 resolved (see phase-1-log.md + convergence table below); 3 streak breaks at P46/49/51; security-burst tails at P43/44/53; latest: Pass 59 FINDINGS (F59-01 BC-5.04.002 v1.3 OBS-20-B reciprocal fix; F59-02→re-obs FU-013); **COUNTER: 0/3**; Pass 60 = restart #3 clean #1 candidate | IN PROGRESS |
...
| T9 | Phase-1d adversarial spec convergence — Passes 1–59 resolved; Pass 59 FINDINGS (F59-01: BC-5.04.002 v1.3 OBS-20-B reciprocal reconciliation fixed; F59-02→re-obs FU-013 no new FU); counter 0/3; Pass 60 = restart #3 clean #1 candidate | **IN PROGRESS** |
...
| LESSONS-CODIFIED | LESSON-F43/F46/F49a/F49b/F52/F53/F56/F58 — all codified in CI checks dd/ee/ff/w/gg/jj/kk. Full text: `.factory/cycles/v0.1.0-greenfield/lessons.md` | — | CODIFIED |
...
**Date:** 2026-06-13
**Phase:** 1 — Spec Crystallization IN PROGRESS. Steps 1–8 DONE + Phase-1d Passes 1–59 DONE.
**Phase-1d Pass 59:** FINDINGS (0C/1I/1obs). F59-01(I): BC-5.04.002 (CAP-005/SS-04) Invariant 2 + Architecture Module implied SS-04 owned the Canon-KB entity registry — contradicting BC-12.12.004's OBS-20-B authority declaration. Fixed: added reciprocal OBS-20-B subordination blockquote at top of BC; reframed Invariant 2 as a validation predicate over the CAP-012-owned registry (explicit "does not itself create, assign, or manage entity IDs"); clarified Architecture Module to "read/validation/integrity-check consumer view" (disclaims registry ownership); added BC-12.12.002/003/004 to Related BCs with consumer-view annotations; added modified[] entry. BC-5.04.002 v1.2→v1.3. BC-12.12.004 NOT touched (already correct). F59-02(obs): BC-13.02.006:149 Related-BCs "competitive-multiplayer lane" label = re-observation of FU-013; no new FU opened.
**Clean-pass counter: 0/3 (counter stays — findings pass; restart #3 still seeking clean #1).** Pass 60 = restart #3 candidate clean #1.
**Next action:** `phase-1d-adversarial` — **Pass 60** (candidate clean #1, restart #3 continues). Spec FROZEN after F59 fix burst. FU-007/FU-008/FU-010/FU-011/FU-012/FU-013/FU-014/FU-016/FU-017/FU-018/FU-019/FU-020/FU-021/FU-022 open (non-blocking). FU-015 CLOSED (F51-02).
...
**Version bumps Pass 59:** BC-5.04.002 v1.3 (F59-01: OBS-20-B reciprocal subordination blockquote; Invariant 2 reframed as validation predicate; Architecture Module clarified to read/validation view; Related BCs BC-12.12.002/003/004 added). BC-INDEX has no per-BC version column — no index edit made. BC count UNCHANGED (193). Spec totals UNCHANGED.
**Open FUs:** FU-005/006/007/008/010/011/012/013/014/016/017/018/019/020/021/022 open (all non-blocking except FU-005 ONGOING). FU-009 CLOSED (Pass-24). FU-015 CLOSED (F51-02). F59-02 confirmed as re-observation of FU-013 — no new FU. See Open Follow-up Items table above.
