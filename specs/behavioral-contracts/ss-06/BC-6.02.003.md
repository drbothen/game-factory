...
| Architecture Module | design-intent-verifier / balance-sim (SS-TBD; assigned by architect) |
...
- `architecture/SS-TBD-design-intent-verifier.md` — design intent and balance verification module
