...
`docs/research/aaa/{engineering-disciplines,qa-testing-liveops,online-services-platform-distribution}.md`,
`docs/research/aaa/AAA-RECONCILIATION.md`, `docs/research/{bevy,unity,godot}-capabilities.md`,
`docs/design/engine-adapter-protocol.md`, `.factory/specs/product-brief.md`.
