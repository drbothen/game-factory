...
> research already in `docs/research/{bevy,unity,godot}-capabilities.md` and the design
> decisions in `docs/design/` and `docs/decisions/`. Where this report touches the eight
...
`docs/research/{bevy,unity,godot}-capabilities.md`,
`docs/research/prior-art-and-precedents.md`, `docs/research/RECONCILIATION.md`,
`docs/design/{architecture,engine-adapter-protocol}.md`,
